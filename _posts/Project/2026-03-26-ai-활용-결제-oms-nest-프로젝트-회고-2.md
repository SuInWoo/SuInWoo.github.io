---
layout: post
title: "AI 활용 결제·OMS Nest 프로젝트 회고 #2"
...
- POST /payments/confirm은 토스 응답 DONE이면 SUCCEEDED, 그 외 PENDING
...
- k6/pay-system.smoke.js에서 POST /payments 포함 E2E 스모크 수행
